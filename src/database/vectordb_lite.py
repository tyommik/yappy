from pymilvus import (
    MilvusClient, FieldSchema, CollectionSchema, DataType, Collection, IndexType, connections
)
...
class VectorDBLite:
    def __init__(self, db_path, collection_name, dimension=64, recreate_collection=False):
        ...
        fields = [
            FieldSchema(name="id", dtype=DataType.INT64, is_primary=True, auto_id=True),  # Поле id
        ...
        index_params = {
            "metric_type": "COSINE",  # Metric type for float vectors
